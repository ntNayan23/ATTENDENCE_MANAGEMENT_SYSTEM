...
# cursor.execute("SELECT id, employee_id, student_id, encoding FROM face_encoding")
# stored_face_encodings = cursor.fetchall()
# with engine.connect() as connection:
#     result = connection.execute(face_encoding_table.select())
#     stored_face_encodings = result.fetchall()
